module.exports = Object.freeze({
  TOKEN: '1032535059:AAFpCTjppCkxLYg6sRhle82IRkhMUascdig', //required
  ARIA_SECRET: 'bhadoo', //change as per needs.
  ARIA_DOWNLOAD_LOCATION: '/app/downloads)', //-leave as it is
  INDEX_DOMAIN: 'https://rakauploader.gautamcloud.workers.dev/Rakauploader/?rootId=0ADbVohZ3aqTNUk9PVA', // replace with your index domain. use https://github.com/ParveenBhadooOfficial/go-drive
  ...
  GDRIVE_PARENT_DIR_ID:  '15T8JtZmuvq6ok1gaAF_qjuQDPTSTEdNR', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  SUDO_USERS: [1223894267],	// Telegram user IDs. These users can use the bot in any chat. required, get it using https://t.me/YourTGid_Bot
  AUTHORIZED_CHATS: [-1001200315499],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@Rakaclouduploader_bot" //Enter your Bot Username here if above is set to true.
    }
});
